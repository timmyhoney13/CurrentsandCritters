...
def run_match(
    ...
    if end_uid is not None and end_uid in gs.deck:
        ...
        rng.shuffle(gs.deck)
        # Guarantee END is in bottom 15: take 14 non-END cards, insert END into them.
        # This is the authoritative final placement and applies to normal AND competitive.
