...
// This used to guard the Casual ("Normal") tab's block, and then the Stats
// page that replaced it. Both are gone, and nothing is left asking for them.
check("the Casual and Stats pages are both gone", !/id="ph-panel-stats"/.test(HTML) && !/id="ph-panel-normal"/.test(HTML)
      && !/__ccStats|stats-page\.js/.test(HTML + APP));
