...
The card reads "Copies the Ocean's ability this card is attached to", and that
is two rules, not one:
...
Both halves are driven through the real engine — real card data, real
